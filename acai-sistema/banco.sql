-- ============================================================
--  AÇAÍ DA SELVA – Banco de Dados
--  Cole este conteúdo no phpMyAdmin > aba SQL > Executar
-- ============================================================

CREATE DATABASE IF NOT EXISTS acai_selva
...
INSERT INTO tamanhos (nome, ml, preco) VALUES
  ('Pequeno', 250, 12.00),
  ('Grande',  400, 18.00);
...
INSERT INTO adicionais (nome, icone, preco, estoque_atual, estoque_minimo) VALUES
  ('Granola',         '🌾', 2.00, 50, 5),
  ('Banana',          '🍌', 2.00, 40, 5),
...
CREATE VIEW vw_adicionais_estoque_baixo AS
  SELECT id, nome, icone, estoque_atual, estoque_minimo
  FROM   adicionais
